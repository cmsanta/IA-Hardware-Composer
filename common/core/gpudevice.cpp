...
bool GpuDevice::DisplayManager::Init(uint32_t fd) {
  ...
  memset(&event_ctx_, 0, sizeof event_ctx_);
  event_ctx_.version = DRM_EVENT_CONTEXT_VERSION;
  event_ctx_.vblank_handler = NULL;
  event_ctx_.page_flip_handler = page_flip_event;
